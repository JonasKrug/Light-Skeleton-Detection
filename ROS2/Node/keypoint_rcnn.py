...
class KeypointRCNN(FasterRCNN):
    ...
    def __init__(
        ...
        num_keypoints=None,
        disable_keypoint_predictor=False,
        **kwargs,
    ):
        ...
        if keypoint_state_predictor is None:
            if not disable_keypoint_predictor:
                keypoint_dim_reduced = 512  # == keypoint_layers[-1]
                keypoint_state_predictor = KeypointStatePredictor(keypoint_dim_reduced, num_keypoints)
        ...
        self.roi_heads.keypoint_state_predictor = keypoint_state_predictor
...
class KeypointStatePredictor(nn.Module):
    def __init__(self, in_channels, num_keypoints):
        super().__init__()
        input_features = in_channels
        self.downsample = nn.Sequential(OrderedDict([
          ('conv1', nn.Conv2d(input_features, num_keypoints, 3, stride=2, padding=0)),
          ('relu1', nn.ReLU()),
          ('conv2', nn.Conv2d(num_keypoints, num_keypoints, 3, stride=2, padding=0)),
          ('relu2', nn.ReLU()),
