...
def visualize_from_output(image, output, plot=True):
    ...
    return visualize_LS(image, bboxes, keypoints, labels, keypoint_states, keypoint_scores=keypoint_scores, plot=plot)
